package br.com.limaflucas.KafkaConsumersExamples.adapters.beans;
...
public class Kafka {
    ...
    @Bean
    KafkaTemplate<String, String> kafkaTemplateBean(ProducerFactory<String, String> producerFactory){
